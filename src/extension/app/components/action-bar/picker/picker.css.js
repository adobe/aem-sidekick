...
export const style = css`
  ...
  @media (prefers-color-scheme: light) {
    :host(:not(.env-edit, .config-switcher):not(.plugin-container)[class]) #button #label,
    :host(:not(.env-edit, .config-switcher):not(.plugin-container)[class]) #button sp-icon-chevron100,
    :host(:not(.env-edit, .config-switcher):not(.plugin-container)[class]) #button:hover sp-icon-chevron100  {
